...
Just from adding more config flags, you can add additional encounters. Two example encounters each, for 5man and 40man tuned for level 39 is already in the package.
